...
public class GeofencingActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
		GoogleApiClient.OnConnectionFailedListener, LocationListener, OnMapReadyCallback, GoogleMap.OnMapClickListener,
	...
	private static final String GEOFENCE_REQ_ID = "Sanelib";
	...
	private void markerForGeofence(LatLng latLng) {
		...
		MarkerOptions markerOptions =
				new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_ORANGE))
						.title(title);
		if (googleMap != null) {
