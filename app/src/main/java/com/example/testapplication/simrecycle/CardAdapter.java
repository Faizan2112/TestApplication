...
import com.example.testapplication.testrec.CustomVolleyRequest;
import com.example.testapplication.simrecycle.SuperHeroes;
...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.ViewHolder> {
    ...
    public CardAdapter(Context context, List<SuperHeroes> superHeroes) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.car_sim, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       // SuperHeroes superHero =  superHeroes.get(position);
        ...
        holder.textViewName.setText(superHeroes.get(position).getName());
